import { AnimatedTooltip, SparklesText } from '@me/comp/aceternity'
import { BrushStroke } from '@me/comp/core'
			...
			tooltip={
				<div className='text-white dark:text-black w-full p-2.5 '>
					<div className='relative'>
						...
						<a href='https://en.wikipedia.org/wiki/Bagan' target='_blank' rel='noreferrer' className='text-sm text-black bg-white  underline  px-1 absolute bottom-0 right-0'>
